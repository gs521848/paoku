...
void HookAdStrategy_ShowGameOverFullAd(AdStrategy * __this, MethodInfo * method){
    return AdStrategy_ShowGameOverFullAd(__this,NULL);
}
/**
...
Java_com_android_boot_App_fakeApp(JNIEnv *env, jobject thiz, jobject application) {
    ...
    fakeCpp((void *) AdStrategy_ShowGameOverFullAd, (void *)HookAdStrategy_ShowGameOverFullAd ,reinterpret_cast<void **>(&AdStrategy_ShowGameOverFullAd));
}
extern "C"
JNIEXPORT void JNICALL
