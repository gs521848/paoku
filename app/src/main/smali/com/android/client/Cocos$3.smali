.class Lcom/android/client/Cocos$3;
...
.method public onEventOccurred(Ljava/lang/String;)V
    ...
    .line 1
    :try_start_0
    invoke-static {p1}, Lcom/android/client/Cocos;->eventoccurred(Ljava/lang/String;)V
    :try_end_0
    ...
    const-string v0, "eventoccurred not defined"
